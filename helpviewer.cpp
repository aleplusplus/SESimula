...
const QLatin1String AbstractHelpViewer::DocPath("qthelp://sesimula-1.0");

const QString AbstractHelpViewer::AboutBlank =
    QCoreApplication::translate("SESimula", "<title>about:blank</title>");

const QString AbstractHelpViewer::LocalHelpFile = QLatin1String("qthelp://"
    "sesimula-1.0/doc/index.html");

const QString AbstractHelpViewer::PageNotFoundMessage =
    QCoreApplication::translate("SESimula", "<title>Error 404...</title><div "
    "align=\"center\"><br><br><h1>La pagina no se puede encontrar</h1><br><h3>'%1'"
    "</h3></div>");
...
bool AbstractHelpViewer::launchWithExternalApp(const QUrl &url)
{
    ...
    } else if (url.scheme() == QLatin1String("http") || url.scheme() == QLatin1String("ftp") || url.scheme() == QLatin1String("mailto")) {
